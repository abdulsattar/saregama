...
export function main() {
  describe('foreach', () => {
    ...
    it('should repeat over nested arrays', (done) => {
      compileWithTemplate('<div><div template="foreach #item in items">' + '<div template="foreach #subitem in item">' + '{{subitem}};' + '</div>|</div></div>').then((pv) => {
        createView(pv);
...
//# sourceMappingURL=/Users/abdulsat/Projects/angular/modules/angular2/test/directives/foreach_spec.map
