...
import {DOM,
  Node} from 'angular2/src/facade/dom';
import {ListWrapper,
  ...
  describe('ViewContainer', () => {
    ...
    describe('should update injectors and parent views.', () => {
      ...
      beforeEach(() => {
        ...
        viewContainer.hydrate(new Injector([]), null);
        var pv = new ProtoView(el('<div class="ng-binding">{{}}</div>'), new DynamicProtoChangeDetector(null), new NativeShadowDomStrategy());
...
//# sourceMappingURL=/Users/abdulsat/Projects/angular/modules/angular2/test/core/compiler/view_container_spec.map
