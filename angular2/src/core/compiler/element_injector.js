...
export class DirectiveDependency extends Dependency {
  constructor(key, asPromise, lazy, properties, depth, eventEmitterName) {
...
export class ProtoElementInjector {
  ...
  instantiate(parent, host, eventCallbacks) {
...
export class ElementInjector extends TreeNode {
  constructor(proto, parent, host, eventCallbacks) {
    super(parent);
...
//# sourceMappingURL=/Users/abdulsat/Projects/angular/modules/angular2/src/core/compiler/element_injector.map
